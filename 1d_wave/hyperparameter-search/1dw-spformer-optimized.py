...
def objective(trial):
    global device, x_res, t_res, x_left, t_left, x_right, t_right, x_upper, t_upper, x_lower, t_lower, x_test, t_test, D1, D2, D3, kernel_size, smallest_rl1
    set_seed(0)
    ...
    if rl1 < smallest_rl1:
        ...
        torch.save(model.state_dict(), f'saves/1dw_spformer_trial_{trial.number}.pth')
